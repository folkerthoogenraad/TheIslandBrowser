...
export class LongDashGameObject extends DrawableGameObject{
   transform: Transform;
   body: Rigidbody;
   ...
   init(game: Game){
      ...
      this.unusedSprite = sheetObjects.getSprite(32, 80, 16, 16).center();
      this.usedSprite = sheetObjects.getSprite(48, 80, 16, 16).center();
   }
