...
export class FeatherGameObject extends GameObject{
   ...
   constructor(aabb: AABB){
      ...
      this.effect = Resources.sheetEffects.getAnimation(0, 80, 16, 16, 4).center();
      this.effect.frameRate = 12;

      this.body.collider = collider;
      
      this.isUsed = false;
      this.unusedSprite = Resources.sheetObjects.getSprite(0, 80, 16, 16).center();
      this.usedSprite = Resources.sheetObjects.getSprite(16, 80, 16, 16).center();
